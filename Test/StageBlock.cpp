...
void StageBlock::Initialize(const Vector3& pos, const Vector3& direction) {
	...
	transform.scale = { 2.0f,2.0f,36.0f };
	direction_ = Quaternion::MakeFromEulerAngle(direction);
	transform.translate = pos;
	transform.rotate = Quaternion::MakeFromTwoVector({0.0f,0.0f,1.0f},direction);
